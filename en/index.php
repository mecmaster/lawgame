                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <a href="index.php#">
                                    <div class="task-info">
                                        <div class="desc">Administrative cases</div>
                            ...
                            <li>
                                <a href="index.php#">
                                    <div class="task-info">
                                        <div class="desc">Commercial cases</div>
                            ...
                            <li>
                                <a href="index.php#">
                                    <div class="task-info">
                                        <div class="desc">Criminal cases</div>
                            ...
                            <li>
                                <a href="index.php#">
                                    <div class="task-info">
                                        <div class="desc">Cases of administrative violations</div>
                                        <div class="percent">100%</div>
                                    </div>
                                    <div class="progress progress-striped">
                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
                            ...
                            <li>
                                <a href="index.php#">
                                    <div class="task-info">
                                        <div class="desc">Civic cases</div>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="profile.html">My Cases</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="mt">
                      <a href="documents.html">
                          <span>Provide documents of the case</span>
</a>
                  </li>
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>2 Minutes Ago</muted><br/>
                      		   <a href="#">James Brown</a> has rated the case <a href="#">про котиків</a><br/>
                      		</p>
                      	</div>
                      </div>
                      <!-- Second Action -->
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>3 Hours Ago</muted><br/>
                      		   <a href="#">Dima Gadomsky</a> has rated the case <a href="#">№14/2378</a>
<br/>
                      		</p>
                      	</div>
                      </div>
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>7 Hours Ago</muted><br/>
                      		   <a href="#">Volodymyr Visnevskyi</a> has rated the case <a href="#">№752/20021/13-к</a>
<br/>
                      		</p>
                      	</div>
                      </div>
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>11 Hours Ago</muted><br/>
                      		   <a href="#">Andrei Ilyuk</a> has rated the case <a href="#">№760/4358/17</a>
<br/>
                      		</p>
                      	</div>
                      </div>
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>18 Hours Ago</muted><br/>
                      		   <a href="#">Alexei Shevchenko</a> has rated the case <a href="#">№507/1289/15-ц</a>
<br/>
                      		</p>
                      	</div>
                      </div>
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            text: 'In this public release you can only rate one Case and only behalf Dmitry Gadomsky. We get data about ongoing cases from Open Data Bot API UA',
